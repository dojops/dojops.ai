    ...
    <section className="ambient-glow bg-bg-primary relative min-h-screen flex flex-col items-center justify-center px-5 pt-24 pb-20">
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-accent-border bg-accent-subtle">
            <span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
            <span className="text-[10px] sm:text-xs font-medium text-accent-text tracking-wide uppercase">
              {t.hero.badge}
            </span>
          </div>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-border-primary bg-bg-card">
            <svg
              width="14"
              height="14"
              viewBox="0 0 24 24"
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 mb-14 sm:mb-16 w-full sm:w-auto px-4 sm:px-0">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-bg-card text-text-primary border border-border-primary hover:bg-bg-card-hover rounded-md px-5 py-2.5 text-sm transition-all"
          >
