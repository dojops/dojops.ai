...
export const en: Translations = {
  ...
  terminal: {
    ...
    routing: "  Scanning repository...",
    routed: "  \u2713 Node.js detected, npm, no CI",
    decomposing: "  Pipeline: build \u2192 test \u2192 containerize \u2192 deploy",
    tasksPlanned: "  Generating files in parallel...",
    task1: "  \u2713 .github/workflows/ci.yml",
    task2: "  \u2713 Dockerfile",
    task3: "  \u2713 docker-compose.yml",
    ready: "  Pipeline generated: 3/3 tasks in 24s",
  },
  tools: {
  ...
  footer: {
    ...
    pixcot: "Pixcot Pixel Art Editor",
    github: "GitHub",
