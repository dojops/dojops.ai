...
export const fr: Translations = {
  platform: {
    ...
    items: [
      ...
      },
      {
        ...
        tagline: "Gerez vos licences et facturation",
        features: [
          "Gestion des licences dojops-sa",
          "Historique de facturation et suivi des paiements",
          "Activation hors ligne pour serveurs isoles",
        ],
  ...
  hero: {
    badge: "Moteur d'automatisation IA",
