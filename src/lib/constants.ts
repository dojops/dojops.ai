...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description:
      "18 built-in skills for the common stuff. Need something specific? Write a DOPS manifest, publish to the Hub, or grab community skills. All verified with SHA-256 checksums.",
    icon: "plugin",
  },
];
